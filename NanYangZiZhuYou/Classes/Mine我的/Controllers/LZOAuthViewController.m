...
//    webView.scalesPageToFit = YES;
    ...
    // 2.用webView加载登录页面
    NSURL *url = [NSURL URLWithString:@"https://api.weibo.com/oauth2/authorize?client_id=874877049&redirect_uri=https://api.weibo.com/oauth2/default.html"];
...
- (void)accessTokenWithCode:(NSString *)code
{
    ...
    params[@"client_id"] = @"874877049";
    params[@"client_secret"] = @"2889299d8dd53abc21a4219fdbcd15a0";
